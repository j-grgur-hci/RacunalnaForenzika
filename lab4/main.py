...
def figMetaData(file_path):
    ...
    if not img_doc.has_exif:
        ...
        gps_latitudee = convertGPScoordinate(img_doc.gps_latitude, img_doc.gps_latitude_ref)
        gps_longitudee = convertGPScoordinate(img_doc.gps_longitude, img_doc.gps_longitude_ref)
        webbrowser.open_new_tab("http://www.google.com/maps/place/"+str(gps_latitudee)+","+str(gps_longitudee))
